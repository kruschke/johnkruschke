...
*define-variables*
!show-sig = no
[req-inits] = "EXPERIMENTER INITIALS ARE MISSING."
[req-booth] = "BOOTH IS MISSING."
[req-age] = "AGE IS MISSING."
[req-sex] = "SEX IS MISSING."
[req-hand] = "HANDEDNESS IS MISSING."
...
"<u>V</u>iew", then "<u>G</u>o&nbsp;To", then "<u>B</u>ack". 
-->
</ul>
<p><hr>
</body>
...
exp_inits=[inits] booth=[booth] subj=[subj] age=[age] sex=[sex] hand=[hand] permute_sec=[permute_sec] 
...
!end-print-if
###
!print-file = "~jkkteach/www/WhitewaterRafting/Main_Instruct"
###

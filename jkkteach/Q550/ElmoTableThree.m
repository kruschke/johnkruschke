...
% >> [X,FVAL,exitflag,output] = fminsearch(@ElmoTableThree,paramInit,searchOptions)
...
PC1PR2   = [ 1 0 0  0 0 1 ]' ;
PC2PR1   = [ 0 0 1  1 0 0 ]' ;
I1PC1PR2 = [ 1 1 0  0 0 1 ]' ;
I2PC2PR1 = [ 0 0 1  1 1 0 ]' ;
...
nProbes = 18;
probe = [ I1 I2 I1PC1PR1 I2PC2PR2 I1PC2 I2PC1 I1PR2 I2PR1 PC1 PC2 PR1 PR2 PC1PR1 PC2PR2 PC1PR2 PC2PR1 I1PC1PR2 I2PC2PR1 ] ;
...
% formatted like Table 3, p.1390 of Kruschke (2001).
elmoTable3 = zeros(9,4);
...
rmse = sqrt( sum(sum(((humanTable3-elmoTable3).^2))) /36) 

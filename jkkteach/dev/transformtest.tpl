...
evaluation of relevance paper number [papernum].  

Please check that the evaluation is made after the paper is due
but before the next paper is due.
...
*append-response*
!append-file-name = "/ip/jkkteach/www/dev/transformtest.dat"
[papernum]	[idnum]	[relevant]	[interesting]	[explanatory]	[timespent]	[classdisc]	[!TIME]	[!DATE]

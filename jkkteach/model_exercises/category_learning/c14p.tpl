...
*success-response*
<html>
<head><title>Case 14</title></head>
<body bgcolor="#FFFFFF">
<FORM
METHOD="POST"
ACTION="transform.cgi?jkkteach/www/model_exercises/category_learning/c14f">
<center>
Case 14 of 16
<p>
<table width=60%>
...
<INPUT TYPE="radio" NAME="r14" VALUE="X">X
<INPUT TYPE="radio" NAME="r14" VALUE="O">O
</td>
</tr>
</table>

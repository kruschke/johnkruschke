...
*Notes:* Unlike most of my poems, this one is autobiographical, with thoughts that really were provoked while mowing the lawn one day. The running theme of the poem is the various ways that I identify with the gray feather, or with the birds that wear the gray feather. And, ultimately, with the impending whirling scythe overhead. One thought that did not make it into the poem is that I am turning gray, too.

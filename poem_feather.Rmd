...
`r qrc_png( url = "https://www.westchesterreview.com/" , journal_name = "*The Westchester Review*" , publication_info = "Spring 2026")`
...
<!-- <p> -->
<!-- <audio controls src="poem_feather.m4a" type="audio/mp4"></audio> -->

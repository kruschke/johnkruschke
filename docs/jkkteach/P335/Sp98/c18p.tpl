...
<FORM 
METHOD="POST" 
ACTION="/cgi-bin-local/public/transform2?jkkteach/www/P335/c18f">
<center>
Test (case 18)
<p>
<table width=60%>
...
<br><INPUT TYPE="radio" NAME="r18" VALUE=1.00>Very Probably X
<br><INPUT TYPE="radio" NAME="r18" VALUE=1.25>Probably X
<br><INPUT TYPE="radio" NAME="r18" VALUE=1.50>Equally X or O
<br><INPUT TYPE="radio" NAME="r18" VALUE=1.75>Probably O
<br><INPUT TYPE="radio" NAME="r18" VALUE=2.00>Very Probably O
</td>
</tr>
</table>

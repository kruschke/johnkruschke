...
*success-response*
<html>
<head><title>Case 01</title></head>
<body bgcolor="#FFFFFF">
<FORM
METHOD="POST"
ACTION="transform.cgi?jkkteach/www/model_exercises/category_learning/c01f">
<center>
Case 1 of 16
<p>
<table width=60%>
...
<INPUT TYPE="radio" NAME="r01" VALUE="X">X
<INPUT TYPE="radio" NAME="r01" VALUE="O">O
</td>
</tr>
</table>

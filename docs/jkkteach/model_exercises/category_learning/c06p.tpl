...
*success-response*
<html>
<head><title>Case 06</title></head>
<body bgcolor="#FFFFFF">
<FORM
METHOD="POST"
ACTION="transform.cgi?jkkteach/www/model_exercises/category_learning/c06f">
<center>
Case 6 of 16
<p>
<table width=60%>
...
<INPUT TYPE="radio" NAME="r06" VALUE="X">X
<INPUT TYPE="radio" NAME="r06" VALUE="O">O
</td>
</tr>
</table>

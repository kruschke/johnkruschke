...
`r qrc_png( qrc_url = "https://johnkruschke.com/poem_any_time.html", journal_url = "https://sagemagazine.org/any-time-spent/" , journal_name = "*SAGE Magazine*" , publication_info = "17 February 2025")`

*Notes:* 
The poem offers several answers to the question, *What is wasted time?* 
It's any time spent not doing fruitful and worthy things. But what are those? Each tercet contemplates a different perspective.
The first suggests what matters is production: babies and money.
The second suggests (Protestant) ethics: working hard and dancing (in my mind, but not explicit in the poem, dancing according to the traditional song `r link_new_tab( "https://en.wikipedia.org/wiki/Simple_Gifts" , "*Simple Gifts:*" )` "by turning, turning we come down right").
...
The fourth suggests that moral engagement and outrage is important, but then suggests mere outrage is unproductive.
...
<p>
<audio controls src="poem_any_time.m4a" type="audio/mp4"></audio>
